...
function ProductsPage() {
  return (
    <div className="bg-[#F0F0F0] mt-4">
      <Head>
        <title>Quins | Color Perfection C Serum 60 ml</title>
        <meta
          name="description"
          content="10 günde cilt tonunu eşitler, güneş ve yaşlılık lekelerini giderir, akne oluşumunu engeller. %10 saf yüz ve boyun c vitamin serumu"
        />
        <meta
          name="keywords"
      ...
      <div className="ml-2 max-w-6xl lg:mx-auto  h-full sm:h-9">
        <ul className="flex">
          ...
          <li className="text-xs font-bold md:mx-1 flex items-center uppercase  cursor-pointer">
            Yüz Ton Eşitleyiciler <RiArrowRightSLine className="md:ml-2" />
          </li>
          <li className="text-xs font-bold md:mx-1 flex items-center uppercase  cursor-pointer">
            Rebooster Serum Series <RiArrowRightSLine className="md:ml-2" />
          </li>
          <li className="text-xs font-bold md:mx-1 flex items-center uppercase  cursor-pointer">
      ...
      <div className="h-full  max-w-6xl mx-auto bg-white rounded-sm p-2 shadow">
        <div className="lg:grid grid-cols-2 lg:divide-x">
          ...
          <div className=" h-full w-full block">
            <img
              src="https://www.vichy.com.tr/site/pages/showImageResized.aspx?EncMediaId=ajZsczVVa0hqcmpUbVFab2FYanUyZz09&ImageFormatAppCode=IMAGEFORMAT_ORIGINAL&v=220224194675"
              alt=""
            />
          </div>
          {/* grid sag taraf */}
          <div className="p-2 md:p-5 mt-3 h-full w-full ">
            ...
            <h1 className="font-thın text-2xl text-red-600 capitalize">
              color perfection c serum - renk ton eşitleyici serum
            </h1>
            ...
            <div className="mb-10">
              <h1 className="uppercase text-lg font-medium tracking-wide leading-5">
                leke Karşıtı etkili formül <br /> 10 günde cilt tonunu eşitler
              </h1>

              <p className="text-base mt-1">
                Yüz ve boyun C Serumu; cildin daha parlak, pürüzsüz ve yumuşak
                olmasını sağlar. Çeşitli nedenlerden kaynaklanan lekelerin
            ...
            <div className="mb-10">
              <h1 className="text-sm font-bold uppercase">advanced formula</h1>
              <ul className="mt-1">
                ...
                <li className="flex items-center text-sm capitalize ">
                  <BsCheck className="mr-1 text-2xl text-red-600" />
                  doğal kaynaklı hyalüronik asit{" "}
                </li>
                <li className="flex items-center text-sm capitalize ">
                  <BsCheck className="mr-1 text-2xl text-red-600" />
                  Allantoin
            ...
            <div className="mb-16">
              <h1 className="uppercase text-lg font-medium tracking-wide leading-5">
                ETKİNLİĞİ <br /> KULLANIMDAN 1 SAAT SONRA - DAHA PARLAK CİLT
                HİSSİ
              </h1>
              ...
              <ul className="space-y-2 mt-2">
                <li className="capitalize text-sm font-medium">
                  %79 daha parlak cilt
                </li>
                <li className="capitalize text-sm font-medium">
                  İnce çizgilerin görünümünde % 21 azalma
                </li>
              </ul>
              <h3 className="capitalize text-lg font-semibold text-red-600 mt-5">
                8 haftalık kullanım:
            ...
            <div className="grid grid-cols-6">
              ...
              <div className="col-span-4">
                <ul>
                  <li className="text-gray-700 capitalize">
                    Normal ciltden yağlı cilde
                  </li>
                  <li className="text-gray-700 capitalize">olgun cilt</li>
                  <li className="text-gray-700 capitalize">hassas cilt</li>
                </ul>
              </div>
              ...
              <div className="col-span-4 mt-3">
                <p className="text-gray-700 capitalize">yüz ve boyun</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="h-full  max-w-6xl mx-auto bg-white rounded-sm p-2 mt-20 shadow">
          ...
          <ul className="flex justify-around my-10">
            <li className="flex flex-col items-center text-2xl md:text-5xl font-bold text-red-600 ">
              %89{" "}
              <span className="text-sm md:text-base font-semibold capitalize text-black mt-3 text-center">
                güneş lekelerinin en aza indirildiyini söyledi
              </span>
            </li>
            <li className="flex flex-col items-center text-2xl md:text-5xl font-bold text-red-600 ">
              %93{" "}
              <span className="text-sm md:text-base font-semibold capitalize text-black mt-3 text-center">
                cildinin daha parlak olduğunu söyledi
              </span>
            </li>
            <li className="flex flex-col items-center text-2xl md:text-5xl font-bold text-red-600 ">
              %90{" "}
              <span className="text-sm md:text-base font-semibold capitalize text-black mt-3 text-center">
                cilt tonu eşitsizliyinin giderildiğini söyledi
              </span>
            </li>
          </ul>
        ...
        <div className="h-full  max-w-6xl mx-auto bg-white rounded-sm py-2 mt-20 shadow">
          ...
          <div className="bg-red-600 mb-10 py-10 px-5 shadow">
            ...
            <p className="text-lg font-medium text-white mt-2">
              Aqua • Ascorbic Acid • Propylene Glycol • Ethyl Alcohol •
              Glycerine • Panthenol • Niacinamide • Phenoxyethanol • Poly
              Sorbate 20 • Fragrance • Hyaluronic acid • Allantoin • Salicylic
              Acid • Alpha-Tocopherol Acetate • Ethyl hexylglycerin.{" "}
            </p>
          </div>
        </div>
      </section>
